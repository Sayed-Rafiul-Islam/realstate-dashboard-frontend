...
import { MaintainerMessagesReducerProps, MessageProps } from "@/types"
...
import { createMaintainerMessage, updateMaintainerMessage } from "@/redux/data/maintainer/messagesSlice"
...
export const CellAction : React.FC<CellActionProps> = ({data}) => {
    ...
    const onView = async () => {
        ...
        if ( result.status === 200) {
            dispatch(updateMaintainerMessage(result.data))    
