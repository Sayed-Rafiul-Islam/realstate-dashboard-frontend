                ...
                <div className="details w-full mt-5 gap-4">
                    <div className="w-1/2 rounded-lg all-shadow">
                        <div className="tenant-image-wrapper">
                            <Image className="rounded-xl" fill src={tenant.user.imageUrl}  alt="picture" />
                        </div>
                        <div className="pb-5">
                        ...
                        <div className="rounded-lg all-shadow py-6">
                            ...
                            <div className="px-5 flex flex-col gap-5">
                                <div className="text-sm flex gap-2 w-full items-center">
                                    ...
                                    <h5>{tenant.property ? tenant.property.name : "N/A"}</h5>
                                </div>
                                <div className="text-sm flex gap-2 w-full items-center">
                                    <h5 className="w-1/2">Address</h5>
                                    <h5>{tenant.property ? tenant.property.address : "N/A"}</h5>
                                </div>
                                <div className="text-sm flex gap-2 w-full items-center">
                                    <h5 className="w-1/2">Unit</h5>
                                    <h5>{tenant.unit ? tenant.unit.name : "N/A"}</h5>
                                </div>
                                <div className="text-sm flex gap-2 w-full items-center">
                                    <h5 className="w-1/2">General Rent</h5>
                                    <h5>{tenant.unit ? `${tenant.property.rent} BDT / ${tenant.property.rentType}` : "N/A"}</h5>
                                </div>
                                <div className="text-sm flex gap-2 w-full items-center">
                                    <h5 className="w-1/2">Payment Due Date</h5>
                                    {/* <h5>{format(tenant.du,"MMMM do, yyyy")}</h5> */}
                                </div>
                            </div>
                        </div>
                    </div>
