...
const maintainanceTypesJson = typeof window !== "undefined" && window.localStorage.getItem("maintainanceTypes")
...
const maintainanceTypesSlice = createSlice({
    ...
    reducers : {
        getMaintainanceTypes : (state, {payload}) => {
            ...
            window.localStorage.removeItem("maintainanceTypes")
            window.localStorage.setItem("maintainanceTypes", JSON.stringify(state.maintainanceTypes))
        },
